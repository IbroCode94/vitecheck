...
import com.vitmedics.vitcheck.config.PropertiesConfig;
 ...
 */
@Component
public class VitcheckException {

    private static final Logger log = LogManager.getLogger(VitcheckException.class);
    private static PropertiesConfig propertiesConfig;

    @Autowired
    public VitcheckException(PropertiesConfig propertiesConfig) {
        VitcheckException.propertiesConfig = propertiesConfig;
    }
